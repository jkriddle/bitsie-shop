...
namespace Bitsie.Shop.Domain.Bitcoin
{
    ...
    public class KeyPair : PublicKey
    {
        ...
        private static long LongRandom(Random rand)
        {
            ...
            return (Math.Abs(longRand % (Int64.MaxValue)));
        }
        ...
        {
            if (usersalt == null) usersalt = "bitsieshop4tw";
            usersalt += DateTime.UtcNow.Ticks.ToString();

            SecureRandom sr = new SecureRandom();
            nonce = LongRandom(new Random(Guid.NewGuid().GetHashCode()));
